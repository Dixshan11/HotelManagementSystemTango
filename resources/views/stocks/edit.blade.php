                        ...
                        <div class="card" style="width:80%;margin: auto">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4 ><span style="color:red">Update</span> <span style="color:blue"> Stock </span>  </h4>
                                    </div>
                                    <div>
                                ...
                                <form action="{{route('stocks.update',$stock->id)}}" method="POST">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control @error('exp_date') is-invalid @enderror" name="exp_date" id="exp_date"  value="{{ old('exp_date',$stock->exp_date) }}">
                                            @error('exp_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
