                        ...
                        <div class="card" style="width:80%;margin: auto">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4 > <span style="color:red">Add</span> <span style="color:blue">Stock </span> </h4>
                                    </div>
                                    <div>
                                        <a href="{{route('stocks.index')}}" class="btn btn-md btn-info float-end">Back</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{route('stocks.store')}}" method="POST">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="quantity">Exp Date</label>
                                            <input type="date" class="form-control @error('exp_date') is-invalid @enderror" name="exp_date" id="exp_date" placeholder="exp_date"  value="{{ old('exp_date') }}">
                                            @error('exp_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
