                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4><span style="color:red">Add New</span> <span style="color:blue"> Room </span></h4>
                                    </div>
                                    <div>
                                        <a href="{{route('rooms.index')}}" class="btn btn-sm btn-info float-end">Back</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{route('rooms.store')}}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select type="text" class="form-control @error('room_type_id') is-invalid @enderror" id="room_type_id" 
                                        name="room_type_id" value="{{ old('room_type_id') }}">
