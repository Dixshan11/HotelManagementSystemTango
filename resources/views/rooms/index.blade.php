                            ...
                            <div class="card-body">
                                <form action="{{route('rooms.index')}}" method="GET">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" class="btn btn-info btn-sm border-rounded"><i class="fas fa-filter"></i> Filter</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4><span style="color:red">Rooms</span> <span style="color:blue">List </span> </h4>
                                    </div>
                                    <div>
                                        <a href="{{route('rooms.create')}}" class="btn btn-sm btn-success float-end">Add Room</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <table class="table table-sm table-bordered" style="font-size: 14px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if ($item->status == 'open' )
                                            <td style="width: 25%"><span class="badge badge-success">Open</span></td>
                                            @else
                                            <td style="width: 25%"><span class="badge badge-danger">Reserved</span></td>
                                            @endif
                                            <td style="width: 25%">
                                                ...
                                                <button onclick="deleteConfirmation('{{$item->id}}')" class="btn btn-sm btn-danger mr-1">
