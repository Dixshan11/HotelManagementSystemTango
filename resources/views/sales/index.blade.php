                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4><span style="color:red">Sales</span> <span style="color:blue"> List </span> </h4>
                                    </div>
                                    <div>
                                        <a href="{{route('sales.create')}}" class="btn btn-sm btn-success float-end">Add Sales</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <table class="table table-sm table-bordered" style="font-size: 14px">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 10%">customer_id</th>
