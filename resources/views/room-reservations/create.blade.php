                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4><span style="color:red">Add</span> <span style="color:blue"> New Reservation</span></h4>
                                    </div>
                                    <div>
                                        <a href="{{route('reservations.index')}}" class="btn btn-sm btn-info float-end">Back</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{route('reservations.store')}}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <button type="button" class="btn btn-white btn-sm" data-toggle="modal" data-target="#customerAddModal">
                                        ...
                                        <select class="form-control customer-search  @error('customer_id') is-invalid @enderror" name="customer_id" id="customer_id"></select>
                                        @error('customer_id')
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select class="form-control room-type  @error('room_type_id') is-invalid @enderror" name="room_type_id" id="room_type_id">
                                        ...
                                        <label for="room_id" class="form-label">Room</label>
                                            <select class="form-control room-type  @error('room_id') is-invalid @enderror" name="room_id" id="room_id">
