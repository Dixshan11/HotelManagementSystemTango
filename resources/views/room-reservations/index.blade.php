                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4><span style="color:red">Reservation</span> <span style="color:blue"> List</span> </h4>
                                    </div>
                                    <div>
                                        <a href="{{route('reservations.create')}}" class="btn btn-sm btn-success float-end">Add Reservation</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
