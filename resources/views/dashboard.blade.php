        ...
        <div class="container-fluid">
            <div class="container">
                <main class="mx-auto m-4">
                    <div class="row">
                        <div class="cardBox">
                            <div class="card"  style="box-shadow: 3px 5px 4px 5px #888888;">
                                <div>
                    ...
                    <div class="row" style="box-shadow: 5px 10px 8px 10px #888888; margin-top:50px;" >
                        <div class="col-md-6 bg-white bg-shadow">
                            <div class="row  bg-white ">
                                <h3 > <span style="color:red;margin-left:150px">Room </span> <span style="color:blue">Reservations </span></h3>
                        ...
                        <div class="col-md-6">
                            ...
                            <h3 > <span style="color:red;margin-left:150px">Liquor </span> <span style="color:blue">Sales </span></h3>
