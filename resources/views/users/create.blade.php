    ...
    <div class="container-fluid">
        <div class="container">
            <main class="mx-auto m-4">
                <div class="row">
                    <div class="col-lg-12 col-md-12" style="box-shadow: 5px 10px 8px 10px #888888; width:800px; padding:20px">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h3> <span style="color:red">Add New </span> <span style="color:blue">User </span></h3>
