...
<div class="container-fluid">
    <div class="container">
        ...
        <h3 class="page-heading rounded"  style="color:blue" >{{ auth()->user()->name }} </h3>
        <div class="row" id="filter-panel">
            <div class="col-12" style="box-shadow: 5px 0px 8px 10px #888888;">
        ...
        <div class="row" id="filter-panel">
            <div class="col-12" style="box-shadow: 5px 10px 8px 10px #888888; width:800px; padding:20px;margin-top:30px">
                <div class="my-3 p-3 bg-white rounded shadow-sm">
